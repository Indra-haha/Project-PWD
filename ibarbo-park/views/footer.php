<footer class="bg-bar-c rubik-font text-warna-primary">
    ...
    <div class="p-3 mx-5 d-flex align-items-center">
        ...
        <div class="d-flex justify-content-between" style="width:30%;">
            ...
            <a href=""><img src="images/twitter-x.svg" alt="twitter" class="m-2" style="height:25px;"></a>
            <a href=""><img src="images/whatsapp.svg" alt="whatsapp" class="m-2" style="height:25px;"></a>
            <a href=""><img src="images/email.svg" alt="email" class="m-2" style="height:25px;"></a>
        </div>
    </div>
